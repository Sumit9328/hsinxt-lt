    ...
    <header className="bg-white shadow-md w-full z-50 top-0 sticky">
      <div className="container mx-auto flex items-center justify-between px-4 py-3 md:py-0">
        ...
        <nav className="hidden md:flex items-center gap-8 relative">
          <a
            href="/"
            className="hover:text-[#db1145] text-[14px] uppercase text-black"
          >
            Home
          </a>
          ...
          <div className="relative group">
            ...
            <div className="absolute top-[52px] left-0 hidden group-hover:block bg-white shadow-lg border border-[#bdbfc1] w-56 py-0 z-50 max-h-64 overflow-y-auto">
              <a
                href="#"
                className="block border-b border-gray-200 px-4 py-2 hover:bg-[#f9e3ec] text-black"
              >
                Honeymoon Gateways
              </a>
              <a
          ...
          <Link href="/MainPages/india">
            <span className="relative flex items-center gap-2 py-4 uppercase hover:text-[#db1145] text-[14px] cursor-pointer">
              {/* No Cost EMI Blinking Sticker */}
              <span className="absolute p-0 m-0 top-[3px] right-[-15px] bg-[#db1145] text-white text-[10px] px-2 rounded-full animate-pulse shadow-md">
                EMI
              </span>
